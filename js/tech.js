const tech = {
    ...
    tech: [{
		...
		{
            name: "Ultra heuristics",
            description: "<strong>+90%</strong> <strong><em>fire rate</em></strong><br>spawn a <strong class='color-g'>gun</strong>, <strong>tech</strong>, <strong> research, and health</strong>",
            maxCount: 9,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
		...
		{
            name: "Ultra Mega heuristics",
            description: "<strong>+90%</strong> <strong><em>fire rate</em></strong><br>spawn a <strong class='color-g'>gun</strong>, <strong>tech</strong>, <strong> research, and health</strong>. But also spawn a dragonfly boss",
            maxCount: 1,
            count: 0,
            frequency: Infinity,
            frequencyDefault: 1,
		...
		{
            name: "drone creator",
            description: "create a drone when you fire the negative knockback",
            maxCount: 1,
            count: 0,
            frequency: 2,
            frequencyDefault: 2,
            allowed() {
                return tech.haveGunCheck("negative knockback")
            },
            requires: "negative knockback",
            effect() {
        ...
        },
        {
            ...
            description: "after firing the <strong>negative knockback</strong> you are <strong>invulnerable</strong><br>shotgun has <strong>50%</strong> fewer shots",
            isGunTech: true,
            maxCount: 1,
            count: 0,
            frequency: 2,
            ...
            effect() {
                ...
                for (i = 0, len = b.guns.length; i < len; i++) { //find which gun 
                    if (b.guns[i].name === "negative knockback") {
        ...
        },
        {
            ...
            description: "<strong>+66%</strong> <strong>negative knockback</strong> <strong><em>fire rate</em></strong> and <strong>recoil</strong>",
            isGunTech: true,
            maxCount: 1,
            count: 0,
            frequency: 2,
            frequencyDefault: 2,
            allowed() {
                return tech.haveGunCheck("negative knockback") && !tech.isShotgunReversed
            },
            requires: "negative knockback, not Noether violation",
            effect() {
        ...
        },
        {
            ...
            description: "<strong>+50%</strong> <strong>negative knockback</strong> <strong class='color-d'>damage</strong><br><strong>shotgun</strong> <strong>recoil</strong> is <strong>reversed</strong>",
            isGunTech: true,
            maxCount: 1,
            count: 0,
            frequency: 1,
            frequencyDefault: 1,
            allowed() {
                return (tech.haveGunCheck("negative knockback")) && !tech.isShotgunRecoil
            },
        ...
        },
        {
            ...
            description: "<strong>negative knockback</strong> drives a long clip of <strong>nails</strong>",
            isGunTech: true,
            maxCount: 1,
            count: 0,
            frequency: 3,
            frequencyDefault: 2,
            allowed() {
                return tech.haveGunCheck("negative knockback") && !tech.isIncendiary && !tech.isRivets && !tech.isIceShot && !tech.isFoamShot && !tech.isSporeWorm && !tech.isSporeFlea && !tech.isNeedles
            },
            requires: "negative knockback, not incendiary, rivets, foam-shot, worm-shot, ice-shot, needles",
            effect() {
        ...
        },
        {
            ...
            description: "<strong>negative knockback</strong> sprays sticky <strong>foam</strong> bubbles",
            isGunTech: true,
            maxCount: 1,
            count: 0,
            frequency: 2,
            frequencyDefault: 2,
            allowed() {
                return tech.haveGunCheck("negative knockback") && !tech.isNailShot && !tech.isIncendiary && !tech.isRivets && !tech.isIceShot && !tech.isSporeWorm && !tech.isSporeFlea && !tech.isNeedles
            },
            requires: "negative knockback, not incendiary, nail-shot, rivet, worm-shot, ice-shot, needle",
            effect() {
        ...
        },
        {
            ...
            description: "<strong>negative knockback</strong> grows freezing <strong class='color-s'>ice IX</strong> crystals",
            isGunTech: true,
            maxCount: 1,
            count: 0,
            frequency: 2,
            frequencyDefault: 2,
            allowed() {
                return tech.haveGunCheck("negative knockback") && !tech.isNailShot && !tech.isIncendiary && !tech.isRivets && !tech.isFoamShot && !tech.isSporeWorm && !tech.isSporeFlea && !tech.isNeedles
            },
            requires: "negative knockback, not incendiary, nail-shot, rivet, foam-shot, worm-shot",
            effect() {
                tech.isIceShot = true;
            },
            remove() {
        ...
        {
            name: "autocannon",
            description: "fire <strong>+1</strong> extra <strong>super ball</strong><br><strong>balls</strong> are quickly released in same direction. Reverses negative knockback's recoil and makes you immune.",
            isGunTech: true,
            maxCount: 1,
            count: 0,
            frequency: 2,
        ...
        // },
        {
            name: "Recoil Increaser",
            description: "<strong>negative knockback</strong> recoil is increased by 66%.",
            maxCount: 1,
            count: 0,
            frequency: 3,
            isJunk: false,
        ...
        {
            name: "negative knockback immunity protocol",
            description: "after <strong>firing</strong> the negative knockback, you are invulnerable",
			maxCount: 1,
			count: 0,
			frequency: 3,
			isJunk: false,
        ...
        {
            name: "Recoil Reverser",
			description: "<strong>negative knockback</strong> recoil is <strong>reversed</strong>",
            maxCount: 1,
            count: 0,
            frequency: 3,
            isJunk: false,
        ...
        {
            name: "return",
            description: "return to introduction<br>reduce combat <strong>difficulty</strong> by <strong>6 levels</strong>",
            maxCount: 1,
            count: 0,
            frequency: 0,
            isJunk: true,
            ...
            requires: "",
            effect() {
                level.difficultyDecrease(simulation.difficultyMode * 6)
                level.onLevel = 2
        ...
        {
            name: "Magenta Laser",
            description: `Turn laser color to <strong>magenta</strong>`,
            maxCount: 1,
            count: 0,
            frequency: 0,
            isJunk: false,
        ...
        {
            name: "Zero Friction",
            description: "You now have no friction",
            maxCount: 1,
            count: 0,
            frequency: 0,
            isJunk: true,
        ...
        },
        {
            ...
            effect() {
                ...
                if (options.length) {
                    const index = options[Math.floor(Math.random() * options.length)]
                    tech.tech[index].frequency = 100000
                }
            },
            remove() {}
        },
        ...
        },
		{
			...
			isJunk: true,
			allowed() { return true },
			requires: "Requires you to be fat",
			effect () {
				window.open("https://www.fattypattys.com/menu/", "blank")
			},
			remove() {}
		},
		{
			name: "Chubby Bubby Services",
			description: "clothes for fat people",
			maxcount: 1,
			count: 0,
			frequency: 0,
			isNonRefundable: true,
			...
			requires: "Requires you to be fat",
			effect () {
				window.open("https://chubbybubbybear.com", "blank")
			},
			remove () {}
		},
