...
const level = {
    ...
    levelAnnounce() {
        ...
        if (level.levelsCleared === 0) {
            document.title = "siddhu-gon: (" + difficulty + ")";
        } else {
            document.title = `siddhu-gon: ${level.levelsCleared} ${level.levels[level.onLevel]} (${difficulty})`
