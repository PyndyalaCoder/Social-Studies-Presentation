...
const m = {
    ...
    fieldUpgrades: [{
        ...
        },
        {
            ...
            effect: () => {
                m.fieldMeterColor = "#00FFFF" //"#0c5"
                m.eyeFillColor = m.fieldMeterColor

                m.fieldShieldingScale = 0;
                m.fieldBlockCD = 3;
                m.grabPowerUpRange2 = 10000000000000000000000
		...
		{
            name: "Tech Shield",
            description: "Spawn a lot of tech, and after that, perfect diamagnetism is your field",
            maxCount: 1,
            count: 0,
            frequency: Infinity,
            frequencyDefault: 1,
            ...
            effect() {
				...
				powerUps.spawn(m.pos.x, m.pos.y, "gun");
				powerUps.spawn(m.pos.x, m.pos.y, "gun"),
				m.fieldMeterColor = "#FF00FF" //"#0c5"
                m.eyeFillColor = "#FF00FF"
        ...
        },
        {
            ...
            effect: () => {
                ...
                m.fieldMeterColor = "rgba(0,255,0)"
                m.eyeFillColor = m.fieldMeterColor
        ...
        },
        {
            ...
            set() {
                ...
                if (tech.isRewindField) {
                    this.rewindCount = 0
                    m.grabPowerUpRange2 = 300000000000
                    m.hold = function() {
                        ...
                        if (m.isHolding) {
                            ...
                            const drain = 0.0003 / (1 + 0.3 * m.coupling)
                    ...
                    m.hold = function() {
                        if (m.isHolding) {
                            ...
                            const drain = 0.00026 / (1 + 0.3 * m.coupling)
                            if (m.energy > drain) m.energy -= drain
                            m.grabPowerUp();
